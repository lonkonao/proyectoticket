<?php if ($_SESSION['nombre'] != "" && $_SESSION['tipo'] == "admin") { ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10">
                <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los usuarios y administradores registrados en Intranet, usted podra eliminarlos si lo desea.</p>
            </div>
        </div>
    </div>
