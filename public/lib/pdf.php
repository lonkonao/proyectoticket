...
$pdf->Image('../img/logoInformatica.png', 40, 10, -550);
$pdf->Cell(0, 5, iconv("UTF-8", "ISO-8859-1", 'Informatica Mdoñihue'), 0, 1, 'C');
...
$pdf->cell(0, 5, utf8_decode("Informatica Mdoñihue 2024"), 0, 0, 'C');

$pdf->Output('informe_' . $reg['serie'] . '.pdf', 'I');
